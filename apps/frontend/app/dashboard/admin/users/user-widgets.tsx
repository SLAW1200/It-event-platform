...
// Client widgets for the admin users table — role picker and active toggle.
// Each binds its action to a user id so the parent server component can
// render N rows that each only target their own user.
import { useActionState } from 'react'
import { setRoleAction, toggleActiveAction, type AdminState } from './actions'

// Order matches UserRole in @event-platform/shared (most to least privileged).
