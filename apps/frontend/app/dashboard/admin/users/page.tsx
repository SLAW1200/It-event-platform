// Admin "users" page — paginated user table with role + active-state
// controls. Only accessible to super_admin / admin (enforced server-side by
// user-service; the UI relies on that rather than re-checking).
