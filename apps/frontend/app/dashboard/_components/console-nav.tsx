// Shared header + sub-nav used by every page under
// `/dashboard/events/[id]/*` so the organiser keeps a consistent context
// while moving between Analytics, Registrations, Forms, etc.
