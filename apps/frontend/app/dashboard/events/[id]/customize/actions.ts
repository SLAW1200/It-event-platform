...
// Server action that saves the per-event landing-page customisation
// (tagline, palette overrides, enabled sections) by PATCHing
// Event.configuration through the gateway, then revalidates both the
// dashboard and the public event page.
