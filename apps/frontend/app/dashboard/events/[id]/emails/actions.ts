...
// Server actions for the per-event email console: create an EmailCampaign
// row, then optionally send it. Send-time pulls the event's confirmed
// registrations and uses them as the recipient list — keeping the choice
// of audience server-side so a client can't target arbitrary emails.
