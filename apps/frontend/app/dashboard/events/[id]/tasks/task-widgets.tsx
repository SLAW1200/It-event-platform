...
// Client widgets for the kanban: <CreateTaskForm /> for the "add task"
// row, <TaskCard /> for each card. COLUMNS is the canonical kanban order
// — also used by the server page to render empty columns in the right order.
