...
// Server action for manually checking a registration in from the check-in
// console — used when an attendee's QR code won't scan. Uses the current
// session's userId as the `staffId` for the audit record.
