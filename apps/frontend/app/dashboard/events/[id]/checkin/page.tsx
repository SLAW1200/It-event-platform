// Check-in console for a single event. Shows live attendance stats and a
// registration list with manual check-in buttons. The companion WebSocket
// gateway in checkin-service pushes real-time scan events to the dashboard
// (live updates wire into the client-side button states).
