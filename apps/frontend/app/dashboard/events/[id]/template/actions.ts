...
// Server action that applies a landing-page template to an event. Patches
// Event.templateId + a default configuration (palette + section list) so
// the customise tab opens with sensible defaults.
