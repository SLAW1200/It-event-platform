// Template picker page — visual gallery of built-in landing-page templates.
// Each card submits applyTemplateAction with its template id; on success
// the user is redirected to /customize to fine-tune the selection.
