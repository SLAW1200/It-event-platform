// Per-event form-builder page — lists existing FormField rows ordered by
// orderIndex and exposes the "add field" form. Each field type drives a
// different input renderer on the public registration page.
