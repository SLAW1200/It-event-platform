...
// Client widgets for the form-builder console: the "add field" form and a
// per-row "Delete" button. Field types come from lib/form-fields.ts (the
// client-safe enum, no server imports).
