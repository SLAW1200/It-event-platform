...
// Inline registration form embedded in the public event page. Takes the
// resolved palette as a prop so its buttons match the organiser's
// customised colours without re-fetching the template.
