...
// Server action for the public attendee-facing signup form. Uses apiPublic
// (no auth header) so visitors who have never logged in can register; the
// backend's /public/register endpoint enforces that the event is live.
