// Public event page (/e/:id) — renders the organiser's chosen template + the
// inline registration form, server-side for SEO. Logged-in organisers preview
// drafts via apiFetch; anonymous visitors use apiPublic (live events only).
